        ...
        <div className="px-6 relative">
            <div className="flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center justify-center md:gap-1 lg:gap-7 text-gray-600">
                    <Link href="/" className="px-1 lg:px-3 py-1 lg:py-2 rounded hover:bg-gray-200 text-sm">Home</Link>
                    <Link href="/servicesPage" className="px-1 lg:px-3 py-1 lg:py-2 rounded hover:bg-gray-200 text-sm">Services</Link>
                    <Link href="/cases" className="px-1 lg:px-3 py-1 lg:py-2 rounded hover:bg-gray-200 text-sm">Cases</Link>
                    <Link href="/blog" className="px-1 lg:px-3 py-1 lg:py-2 rounded hover:bg-gray-200 text-sm">Blog</Link>
                    <Link href="/contactUs" className="px-1 lg:px-3 py-1 lg:py-2 rounded hover:bg-gray-200 text-sm">Contact Us</Link>
                </div>
