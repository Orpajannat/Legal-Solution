...
export default function Planning () {
  return (
    <div className="flex flex-col items-center justify-center gap-5 py-30">
        <h2 className="text-4xl text-taupe-600">Estate planning forms and business solutions made easy</h2>
        <p className="text-base text-taupe-600">Planning your future or starting your business doesn’t have to be expensive or time consuming.</p>
        <div className="flex flex-row items-center justify-center gap-10 p-10">
            ...
            <div className="flex flex-col justify-center gap-5">
               ...
               <p className="text-taupe-600">
                ...
                <button className="px-4 py-3 rounded-lg bg-taupe-700 text-white font-bold cursor-pointer w-fit">
                   Protect my family
                </button>
            </div>
        </div>
