  ...
  return (
    <div className="py-3 bg-white">
        <div className="relative w-full h-150">
            <Image src={heroBanner.hero_background_image} alt="herobanner" fill className="object-cover md:rounded-lg"/>
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center gap-7 md:px-0 px-4">
                <h3 className="text-white text-2xl md:text-4xl lg:text-6xl font-bold">
                    {heroBanner.hero_title}
                </h3>
                <h1 className="text-white text-xs md:text-base lg:text-lg">
                ...
                <div className="flex gap-5">
                    ...
                    <button className="bg-taupe-600 px-3 md:px-8 lg:px-12 md:rounded-lg rounded text-white md:text-base text-xs font-semibold">
                        Search
                    </button>
                </div>
            </div>
